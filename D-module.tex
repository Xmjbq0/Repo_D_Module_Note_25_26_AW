...
\newcommand{\relo}{\displaystyle\omega_{X/Y}}
%
...
\newcommand{\numo}{\nu_{\text{mod}}}
\newcommand{\numid}{\nu_{\text{mid}}}
\newcommand{\pen}{\tilde{X}\setminus X_{\infty}}
\renewcommand{\ref}[1]{\hyperref[#1]{\ref*{#1}}}
\newcommand{\dcat}{D^b_c(X)}
\newcommand{\hyp}{\mathbb{H}}
\renewcommand{\d}[1]{{#1^\bullet}}
\newcommand{\oball}[1]{\overset{\circ}{B}_{\epsilon}(#1)}
\newcommand{\nearby}[1]{\Psi_f\d{#1}}
\newcommand{\nearbyd}[2]{\Psi_{f, #2}\d{#1}}
\newcommand{\vanish}[1]{\Phi_f\d{#1}}
\newcommand{\vanishd}[2]{\Phi_{f, #2}\d{#1}}
\newcommand{\phinity}{\phi_{\infty}}
\newcommand{\grV}{\gr_{\bullet}^V}
\newcommand{\grd}[2]{\gr^\bullet_{#1}#2}
\newcommand{\gri}[2]{\gr_\bullet^{#1}#2}
\newcommand{\biG}[1]{G(#1, \d K)}
