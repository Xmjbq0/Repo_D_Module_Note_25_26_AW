...
\begin{proof}
    ...
    \noindent Take $U' \subseteq Y$, an open affine neighborhood such that $U = U' \cap V$ and $\ker \varphi|_U$ is free of rank $r = \dim Y - \dim V$ with generators $dx_1, \dots, dx_r \in \Omega_Y$.
