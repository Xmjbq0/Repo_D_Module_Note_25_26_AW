...
\begin{remark}
    ...
    \begin{enumerate}
        \item \textbf{Step1: Notation and dictionary}
              ...
              \begin{enumerate}
                  \item This definition don't guarantees $\mathcal I_D$ is reduced.
        ...
        \item \textbf{Step 4: Proof of sentence (1): $\mathrm{DR}((M^\alpha)^\mathrm{an})\simeq Rj_*(f^{-1}L_1^\lambda)$}
              ...
              \]
              Since we $\sigma$ is an isomorphism over $U$.
        ...
        \item \textbf{Step 5: Proof of sentence (2): $\mathrm{DR}(\mathcal D_X[s]f^{s+k}\otimes \mathbb C_\alpha)\simeq j_!(f^{-1}L_1^\lambda)$}
              ...
              Let $M=\mathcal O_X$ and $M_0=\mathcal O_X$.
              Wu proves that for every $\alpha$ there exists $k_0$ such that for all integers $k>k_0$,
              \[
                  j_!\big(\mathcal O_U\cdot f^\alpha\big)\ \simeq\
                  \mathcal D_X[s]_{\mathfrak m_\alpha}\,\mathcal O_X\cdot f^{s+k}\ \otimes^{\mathbf L}_{\mathbb C[s]}\ \mathbb C_\alpha
                  \qquad
                  \text{\cite[Thm.~2.10(3)]{Wu2020ComparisonNearbyCyclesBfunctions}}.
              \]
              Applying the analytic de Rham functor and using that $\mathrm{DR}$ commutes with $j_!$
              under Riemann--Hilbert (six-functor compatibility) \cite[Thm.~11.5]{MurayamaMHM}, we get
              \[
                  \mathrm{DR}_X\!\left(\left(\mathcal D_X[s] f^{s+k}\otimes_{\mathbb C[s]}\mathbb C_\alpha\right)^\mathrm{an}\right)
                  \simeq
                  j_!\,\mathrm{DR}_U\big((\mathcal O_U\cdot f^\alpha)^\mathrm{an}\big)
                  \simeq
                  j_!(f^{-1}L_1^\lambda),
              \]
              as desired.
