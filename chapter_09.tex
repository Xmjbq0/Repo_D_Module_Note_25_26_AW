...
\begin{example}
    ...
    \begin{enumerate}
        \item Identify $X$ as a closed subscheme of $X\times_{\Spec\C}\mathbb{A}^1_{\C}$.
        ...
        \item Introduce two coordinate systems on $Y:=X\times_{\Spec\C}\mathbb{A}^1_{\C}$.
        ...
        \item Identify the transfer bimodules.
        ...
        \item Identify the direct image.
        ...
        \item Identification as a left $\D_Y$-module, the result should be compatible with \cite[discussion above Prop.~1.4]{Budur04}.
        ...
        \item Take $M= R_f$, further identification, the result should be consistent with \cite[the $\D_X$-action on $B_{f,+}$]{Lee2025MultiplicativeThomSebastianiBSato_JAlgebra}.
